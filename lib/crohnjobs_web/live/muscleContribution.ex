defmodule CrohnjobsWeb.MuscleContribution do
          ...
          case Repo.get(Muscles, muscle_id) do
            nil ->
              {:ok,
               ...
               |> push_navigate(to: "/trainer/clients/#{client_id}/volumeTracking")}
              ...
              raw =
                Repo.all(
                  from wd in WorkoutDetails,
                    ...
                    where: w.client_id == ^client_id and emc.muscle_id == ^muscle_id,
                    select: %{
                      exercise_id: e.id,
