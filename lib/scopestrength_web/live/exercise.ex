...
def handle_event("submit", _unsigned_params, socket) do
  Scopestrength.WorkoutTracker.programme(%{name: socket.assigns.name, date: socket.assigns.date, exercises: socket.assigns.exercises})
        ...
        <div class="bg-card rounded-2xl shadow-xl border border-line p-6">
          <div class="flex items-center justify-between">
            <div class="flex items-center  space-x-3">
              ...
              <h1 class="text-3xl  font-bold bg-card bg-clip-text text-transparent">
                Workout Builder
              </h1>
            </div>
            <%= if @report == "true" do %>
        ...
        <div class="bg-card rounded-2xl shadow-xl border border-line p-6 space-y-6">
          ...
          <div class="grid md:grid-cols-2 gap-6">
            ...
            <form  phx-change="dateChange" class="space-y-2">
              <label class="block text-sm font-semibold text-foreground">Workout Date</label>
              <.input
                type="date"
                name="date"
                value={@date}
          ...
          <div class="pt-4">
        <.button class="bg-gradient-to-r from-red-500 to-red-600 hover:from-red-500 hover:to-red-600 text-foreground px-6 py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 flex items-center space-x-2 font-semibold" phx-click="reset">
                ...
                <div class="bg-card p-6 border-b border-line">
                  <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-3">
                      ...
                      <.button
                        class="bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-foreground px-4 py-2 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 flex items-center space-x-2 font-medium"
                        phx-value-id={exercise.id}
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <%= for workout <- exercise.workout do %>
                      <div class="bg-card border-2 border-line rounded-xl p-4 space-y-4 hover:shadow-md transition-all duration-200">
                        ...
                        <div class="space-y-3">
                          <div>
                            <label class="block text-xs font-medium text-dim mb-1">Reps</label>
                            <.input
                              type="number"
                          ...
                          <div>
                            <label class="block text-xs font-medium text-dim mb-1">Weight (lbs)</label>
                            <.input
                              type="number"
                        ...
                        <div class="pt-2 border-t border-line">
                          <.button
                            ...
                            class="w-full text-danger hover:text-danger hover:bg-danger/10 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 flex items-center justify-center space-x-2"
                          >
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/>
                            </svg>
