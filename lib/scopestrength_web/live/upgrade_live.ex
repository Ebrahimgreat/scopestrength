        ...
        <div class="text-center">
          ...
          <div class="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
            ...
            <a
              ...
              class="inline-flex items-center gap-2 px-6 py-3 bg-blue-600 text-foreground font-semibold rounded-lg hover:bg-blue-700 transition-colors"
            >
          ...
          <div class="grid md:grid-cols-3 gap-6 mb-8">
            <div class="text-left">
              <div class="flex items-center gap-2 mb-2">
                ...
                <h3 class="font-semibold text-foreground">Unlimited Clients</h3>
              </div>
              <p class="text-dim text-sm">Manage as many clients as you need</p>
            </div>
            ...
            <div class="text-left">
              <div class="flex items-center gap-2 mb-2">
                ...
                <h3 class="font-semibold text-foreground">Full Access</h3>
              </div>
              <p class="text-dim text-sm">All features unlocked</p>
            </div>
            ...
            <div class="text-left">
              <div class="flex items-center gap-2 mb-2">
                ...
                <h3 class="font-semibold text-foreground">Priority Support</h3>
              </div>
              <p class="text-dim text-sm">Get help when you need it</p>
            </div>
          </div>

          <%= if String.starts_with?(@current_user.email, "demo_") do %>
            <div class="bg-warning/10 border border-warning rounded-lg p-5 mb-6">
              <h3 class="font-semibold text-warning mb-2">Enjoying the demo?</h3>
              ...
              <a
                ...
                class="inline-flex items-center gap-2 px-4 py-2 bg-warning text-foreground font-medium rounded-lg hover:bg-amber-700 transition-colors text-sm"
              >
