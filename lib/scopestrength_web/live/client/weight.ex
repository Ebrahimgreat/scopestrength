...
defmodule ScopestrengthWeb.Client.Weight do
  ...
  def render(assigns) do
    ~H"""
    <div class="min-h-screen bg-gradient-to-br from-primary via-teal-50 to-cyan-50 py-8 px-4 sm:px-6 lg:px-8">
      <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-card rounded-2xl shadow-xl p-8 mb-6 border border-line">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-dim">Track your weight over time and monitor your progress</p>
            </div>
            <button
        ...
        <%= if @show_modal do %>
          <div class="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4 backdrop-blur-sm">
            <div class="bg-card rounded-2xl shadow-2xl w-full max-w-md transform transition-all">
              <div class="p-6 border-b border-line bg-primary">
                <h2 class="text-2xl font-bold text-foreground">Log Weight</h2>
                <p class="text-dim text-sm mt-1">Record your weight for today</p>
              </div>
              ...
              <.form phx-submit="add_weight" for={@form}>
                <div class="p-6 space-y-5">
                  ...
                  <div>
                    <label class="block text-sm font-semibold text-foreground mb-2">Weight (kg)</label>
                    <.input
                      type="number"
                      field={@form[:weight]}
                      step="0.1"
        ...
        <%= if length(@weights) >= 2 do %>
          <div class="bg-card rounded-2xl shadow-lg p-6 mb-6 border border-line">
            ...
            <div class="flex items-center justify-center gap-6 mt-3 text-sm text-dim">
              ...
              <div class="flex items-center gap-2">
                <div class="w-6 h-0.5 bg-warning rounded" style="border-top: 2px dashed #f59e0b; background: none;"></div>
                <span>Trend (EMA)</span>
              </div>
            </div>
            <div class="flex justify-between text-xs text-dim mt-2 px-14">
          ...
          <div class="bg-card rounded-2xl shadow-lg border border-line overflow-hidden">
            ...
            <div class="divide-y divide-line">
              <%= for weight <- Enum.reverse(@weights) do %>
                <div class="px-6 py-4 flex items-center justify-between hover:bg-primary/10 transition-colors">
                  <div class="flex items-center gap-4">
                    ...
                    <div>
                      <span class="text-sm text-dim"><%= weight.date %></span>
        ...
        <% else %>
          <div class="bg-card rounded-2xl shadow-lg p-12 text-center border border-line">
            ...
            <h3 class="text-2xl font-bold text-foreground mb-2">No Weight Entries Yet</h3>
