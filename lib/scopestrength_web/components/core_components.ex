...
defmodule ScopestrengthWeb.CoreComponents do
  ...
  use Gettext, backend: ScopestrengthWeb.Gettext
  ...
  def button(assigns) do
    ...
    <button
      ...
      class={[
        ...
        "text-sm font-semibold leading-6 text-primary-foreground active:opacity-80 transition-colors",
        @class
      ]}
      {@rest}
    >
  ...
  def input(%{type: "checkbox"} = assigns) do
    ...
    ~H"""
    <div>
      <label class="flex items-center gap-4 text-sm leading-6 text-dim">
        ...
        <input
          ...
          value="true"
          checked={@checked}
          class="rounded border-line text-foreground focus:ring-0"
          {@rest}
        />
        {@label}
      </label>
  ...
  def input(%{type: "select"} = assigns) do
    ...
    <div>
      ...
      <select
        id={@id}
        name={@name}
        class="mt-2 block w-full rounded-md border border-line bg-card shadow-sm focus:border-zinc-400 focus:ring-0 sm:text-sm"
        multiple={@multiple}
        {@rest}
      >
    ...
    <div>
      ...
      <textarea
        ...
        class={[
          ...
          @errors == [] && "border-line focus:border-zinc-400",
  ...
  def error(assigns) do
    ~H"""
    <p class="mt-3 flex gap-3 text-sm leading-6 text-danger">
  ...
  def header(assigns) do
    ...
    <header class={[@actions != [] && "flex items-center justify-between gap-6", @class]}>
      <div>
        ...
        <p :if={@subtitle != []} class="mt-2 text-sm leading-6 text-dim">
  ...
  def table(assigns) do
    ...
    <div class="overflow-y-auto px-4 sm:overflow-visible sm:px-0">
      <table class="w-[40rem] mt-11 sm:w-full">
        <thead class="text-sm text-left leading-6 text-dim">
          <tr>
        ...
        <tbody
          ...
          class="relative divide-y divide-line border-t border-line text-sm leading-6 text-foreground"
        >
          <tr :for={row <- @rows} id={@row_id && @row_id.(row)} class="group hover:bg-zinc-50">
            ...
            <td :if={@action != []} class="relative w-14 p-0">
              <div class="relative whitespace-nowrap py-4 text-right text-sm font-medium">
                ...
                <span
                  :for={action <- @action}
                  class="relative ml-4 font-semibold leading-6 text-foreground hover:text-foreground"
                >
    ...
    <div class="mt-14">
      <dl class="-my-4 divide-y divide-line">
        <div :for={item <- @item} class="flex gap-4 py-4 text-sm leading-6 sm:gap-8">
          <dt class="w-1/4 flex-none text-dim">{item.title}</dt>
  ...
  def back(assigns) do
    ...
    <div class="mt-16">
      <.link
        navigate={@navigate}
        class="text-sm font-semibold leading-6 text-foreground hover:text-foreground"
      >
  ...
  def translate_error({msg, opts}) do
    if count = opts[:count] do
      ...
      Gettext.dgettext(ScopestrengthWeb.Gettext, "errors", msg, opts)
    end
  end
