defmodule Scopestrength.MeasurementsTest do
  use Scopestrength.DataCase

  alias Scopestrength.Measurements

  describe "measurements" do
    alias Scopestrength.Measurements.Measurement

    import Scopestrength.MeasurementsFixtures
  ...
  describe "measurementdata" do
    alias Scopestrength.Measurements.MeasurementData
