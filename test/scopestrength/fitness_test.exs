defmodule Scopestrength.FitnessTest do
  use Scopestrength.DataCase

  alias Scopestrength.Fitness

  describe "workouts" do
    alias Scopestrength.Fitness.Workout

    import Scopestrength.FitnessFixtures
  ...
  describe "workout_details" do
    alias Scopestrength.Fitness.WorkoutDetail
  ...
  describe "workout_details" do
    alias Scopestrength.Fitness.WorkoutDetaial
